...
from cleverhans.train_cls_lat import train_cls_lat
from cleverhans.model_zoo.basic_ae import ModelBasicAE
from cleverhans.model_zoo.basic_cls_lat import ModelCls
...
def mnist_tutorial_cw(train_start=0, train_end=60000, test_start=0,
  ...
  def do_eval_cls(preds, x_set, y_set, x_tar_set,report_key, is_adv = None):
    acc = model_eval(sess, z, y, preds, z_t, x_set, y_set, x_tar_set, args=eval_params_cls)
  ...
  def eval_cls():
    do_eval_cls(y_logits, x_test_lat, y_test, x_test_lat,'clean_train_clean_eval', False)

  #train_cls(sess, loss_cls, x_train, y_train, evaluate = eval_cls, args = train_params_cls, rng = rng, var_list = cl_model.get_params())
  train_cls_lat(sess, loss_cls, x_train_lat, y_train, evaluate = eval_cls, args = train_params_cls, rng = rng, var_list = cl_model.get_params())
