...
from cleverhans.loss import SquaredError, vae_loss
...
from cleverhans.model_zoo.basic_vae import ModelVAE
...
def cifar10_cw_recon(train_start=0, train_end=60000, test_start=0,
  ...
  if clean_train_vae==True:
    ...
    train_ae(sess, loss, x_train, x_train, evaluate=evaluate_ae,
          args=train_params, rng=rng, var_list = wrap_vae.get_params())
